		...
		function(buffer) {
			...
			$('#info')
				.fadeOut('normal', function() {
					$(this).html('<div id="artist"><a class="name" href="https://soundcloud.com/zivert-music" target="_blank">Zivert</a><br /><a class="song" href="https://soundcloud.com/bfz5uiut5y9t/zivert-credo" target="_blank">Credo</a><br /></div><div><img src="data/coyote_kisses.jpg" width="58" height="58" /></div>');
				})
				.fadeIn();
